...
<form action="<?= ROOT_PATH ?>/users/create" method="post">
    ...
    <div class="form-group my-3">
        ...
        <input type="password" name="password" class="form-control" value="<?= $form_fields["password"] ?? null ?>">
    </div>

    <div class="form-group my-3">
        <label for="password_confirmation">Password Confirmation</label>
        <input type="password" name="password_confirmation" class="form-control" value="<?= $form_fields["password_confirmation"] ?? null ?>">
    </div>
